  ...
  return (
    <div>
              ...
              {currentTodo ? (
                <>
                  <button
                    ...
                    className="bg-greenTeal text-white py-3 px-10 rounded-md"
                  >
                    Save
                  </button>
                  <button
      ...
      <div className=" flex items-center justify-center flex-col">
        {todoList.length === 0 ? (
          <div className="mb-6">
            ...
            <p className="text-center text-Gray">
              No records found Try adding an event
            </p>
          </div>
        ) : (
        ...
        <button
          className="bg-greenTeal text-center text-white py-3 px-10 rounded-md"
          onClick={() => {
            setShowModal(true);
          }}
        >
